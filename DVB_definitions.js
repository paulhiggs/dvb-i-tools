...
const _S_RollOff = ["0.35"],
			_S_FEC = ["1/2", "3/5", "2/3", "3/4", "4/5", "5/6", "7/8", "8/9", "9/10"],
			_S_Modulation = ["QPSK"];

const _S2_RollOff = ["0.25", "0.20"].concat(_S_RollOff),
			_S2_FEC = _S_FEC,
			_S2_Modulation = ["8PSK"].concat(_S_Modulation);

const _S2X_RollOff = ["0.15", "0.10", "0.05"].concat(_S2_RollOff),
			_S2X_FEC = ["1/4", "1/3", "2/5", "13/45", "9/20", "11/20", "23/36", "13/18", "5/9", "26/45", "28/45", "7/9", "77/90", "8/15", "32/45", "11/15"].concat(_S_FEC),
			_S2X_Modulation = ["8PSK-L", "16APSK", "16APSK-L", "32APSK", "32APSK-L", "64APSK", "64APSK-L"].concat(_S2_Modulation);
