...
export const CMCD_MODE_REQUEST : string = `${CMCDterm}:delivery:request`,
	CMCD_MODE_RESPONSE : string = `${CMCDterm}:delivery:response`,
	CMCD_MODE_EVENT : string = `${CMCDterm}:delivery:event`;
