...
export let isMIME = (mime : string) : boolean => (datatypeIs(mime, "string") ? simple_mime_regex.test(mime.trim()) : false);
 ...
 */
export let isJPEGmime = (mime : string) : boolean => (mime ? mime == JPEG_MIME : false);
 ...
 */
export let isPNGmime = (mime : string) : boolean => (mime ? mime == PNG_MIME : false);
 ...
 */
export let isWebPmime = (mime : string) : boolean => (mime ? mime == WebP_MIME : false);
 ...
 */
export let isAllowedImageMime = (mime : string) : boolean => (mime ? allowedImageTypes.includes(mime) : false);
 ...
 */
export let isRequiredImageMime = (mime : string) : boolean => (mime ? REQUIRED_MIMES.includes(mime) : false);
