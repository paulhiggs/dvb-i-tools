...
import { datatypeIs, DefaultProperty, HasProperty } from "./utils.mjs";
...
export default class ErrorList {
	...
	addError(e) {
		...
		if (e.type == DEBUG) {
			...
			const newError = { code: e.code, message: e.message, element: datatypeIs(e.fragment, "string") ? e.fragment : this.#prettyPrint(e.fragment) };
			...
			const newError = { code: e.code, message: e.message, element: null };
			if (e.line) {
				this.#setError(e.type, e.code, e.message, e.line);
				newError.line = e.line;
			}
