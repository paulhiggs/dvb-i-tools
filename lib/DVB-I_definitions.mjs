...
export const dvbiEA = {
	...
	CMCDv2: [dvbi.a_reportingMode, dvbi.a_eventURL, dvbi.a_transmissionMode, dvbi.a_batchSize, dvbi.a_reportingMethod, dvbi.a_contentId, dvbi.a_enabledKeys, dvbi.a_probability, dvbi.a_obfuscateURL],
