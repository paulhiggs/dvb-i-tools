...
export const CMCD_MODE_RESPONSE = `${CMCDterm}:delivery:response`,
...
export const validApplicationTypes = [dvbi.XML_AIT_CONTENT_TYPE, dvbi.HTML5_APP, dvbi.XHTML_APP];
...
export const dvbiEC = {
	...
	OrganizationType: [mpeg7.e_Name, mpeg7.e_Kind, mpeg7.e_ContactName, mpeg7.Jurisdiction, mpeg7.e_Address, mpeg7.e_ElectronicAddress],
};
