...
export const CMCD_MODE_EVENT = `${CMCDterm}:delivery:event`;
...
export const CMCD_METHOD_HTTP_HEADER = `${CMCDterm}:delivery:customHTTPHeader`,
	...
	CMCD_METHOD_BATCH = `${CMCDterm}:delivery:batch`;
...
export const dvbi = {
	...
	A177r8_Namespace: `${DVB_metadata}:servicediscovery:202x`,
...
export const dvbisld = {
	...
	A177r8_Namespace: `${DVB_metadata}:servicelistdiscovery:202x`,
...
// A177 clause 5.2.4.1
export const DvbIApplicationTyes = [dvbi.HTML5_APP, dvbi.XHTML_APP, HBBTV_APP_TYPE];
...
export const dvbiEA = {
	...
	CMCD: [dvbi.a_reportingMode, dvbi.a_transmissionMode, dvbi.a_reportingMethod, dvbi.a_contentId, dvbi.a_enabledKeys, dvbi.a_probability],
	CMCDv2: [dvbi.a_reportingMode, dvbi.a_transmissionMode, dvbi.a_reportingMethod, dvbi.a_contentId, dvbi.a_enabledKeys, dvbi.a_probability, dvbi.a_beaconURL, dvbi.a_interval],
