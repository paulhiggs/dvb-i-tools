...
const tvaBaseMemberOfTypeAttributes : Array<string> = [tva.a_crid, tva.a_index],
	tvaControlledTermTypeAttributes : Array<string> = [tva.a_href],
	tvafragmentIdentificationAttributes : Array<string> = [tva.a_fragmentId, tva.a_fragmentVersion, tva.a_fragmentExpirationDate],
	mpeg7UniqueIDTypeAttributes : Array<string> = [mpeg7.a_type, mpeg7.a_organization, mpeg7.a_authority, mpeg7.a_encoding];
...
const ProgramLocationType : Array<string> = [tva.e_Program, tva.e_ProgramURL, tva.e_AuxiliaryURL, tva.e_InstanceMetadataId, tva.e_InstanceDescription];
export const BaseAccessibilityAttributesType : Array<string> = [tva.e_AppInformation, tva.e_Personalisation];
