...
const deprecated_CMCDv1_keys = [{ key: CMCD_keys.next_range_request, allow_modes: request_mode_only }];
...
const CMCDv2_keys = CMCDv1_keys.concat([
	...
	{ key: CMCD_keys.buffer_starvation_duration, allow_modes: request_mode_only },
	...
	{ key: CMCD_keys.CMSD_dynamic_header, allow_modes: request_mode_only },
	{ key: CMCD_keys.CMSD_static_header, allow_modes: request_mode_only },
	{ key: CMCD_keys.SMT_header, allow_modes: event_mode_only },
