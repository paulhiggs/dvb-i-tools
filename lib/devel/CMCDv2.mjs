...
const request_mode_only = [CMCD_MODE_REQUEST],
	...
	all_reporting_modes = [CMCD_MODE_REQUEST, CMCD_MODE_EVENT];
...
const CMCDv2_keys = [
	...
	{ key: CMCD_keys.buffer_starvation_duration, allow_modes: all_reporting_modes },
	...
	{ key: CMCD_keys.object_duration, allow_modes: all_reporting_modes },
	{ key: CMCD_keys.dropped_frames, allow_modes: all_reporting_modes },
	{ key: CMCD_keys.deadline, allow_modes: all_reporting_modes },
	...
	{ key: CMCD_keys.next_object_request, allow_modes: all_reporting_modes },
	{ key: CMCD_keys.non_rendered, allow_modes: all_reporting_modes },
	{ key: CMCD_keys.object_type, allow_modes: all_reporting_modes },
	...
	{ key: CMCD_keys.requested_maximum_throughput, allow_modes: all_reporting_modes },
