...
const OutOfScheduledHoursBanners = [
	{ ver: SCHEMA_r8, val: dvbi.BANNER_OUTSIDE_AVAILABILITY_v3 },
...
const ContentFinishedBanners = [
	{ ver: SCHEMA_r8, val: dvbi.BANNER_CONTENT_FINISHED_v3 },
...
const ServiceListLogos = [
	{ ver: SCHEMA_r8, val: dvbi.LOGO_SERVICE_LIST_v3 },
...
const ServiceLogos = [
	{ ver: SCHEMA_r8, val: dvbi.LOGO_SERVICE_v3 },
...
const ServiceBanners = [
	{ ver: SCHEMA_r8, val: dvbi.SERVICE_BANNER_v4 },
...
const ContentGuideSourceLogos = [
	{ ver: SCHEMA_r8, val: dvbi.LOGO_CG_PROVIDER_v3 },
...
export let validAgreementApplication = (hrefType, schemaVersion) => schemaVersion >= SCHEMA_r7 && appTypes.includes(hrefType);
...
SchemaVersions.forEach((version) => {
	...
	if (buf)
		version.schema = XmlDocument.fromBuffer(buf);
