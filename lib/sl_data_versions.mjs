 ...
 */
export const SchemaSpecVersion = (version) => {
 ...
 */
export const GetSchema = (namespace) => SchemaVersions.find((s) => s.namespace == namespace);
 ...
 */
export const validOutScheduleHours = (HowRelated) => match(OutOfScheduledHoursBanners, HowRelated.attrAnyNsValueOr(dvbi.a_href, null), HowRelated.documentNamespace());
 ...
 */
export const validContentFinishedBanner = (HowRelated) => match(ContentFinishedBanners, HowRelated.attrAnyNsValueOr(dvbi.a_href, null), HowRelated.documentNamespace());
 ...
 */
export const validServiceListLogo = (HowRelated) => match(ServiceListLogos, HowRelated.attrAnyNsValueOr(dvbi.a_href, null), HowRelated.documentNamespace());
 ...
 */
export const validServiceLogo = (HowRelated) => match(ServiceLogos, HowRelated.attrAnyNsValueOr(dvbi.a_href, null), HowRelated.documentNamespace());
 ...
 */
export const validServiceBanner = (HowRelated) => match(ServiceBanners, HowRelated.attrAnyNsValueOr(dvbi.a_href, null), HowRelated.documentNamespace());
 ...
 */
export const validContentGuideSourceLogo = (HowRelated) => match(ContentGuideSourceLogos, HowRelated.attrAnyNsValueOr(dvbi.a_href, null), HowRelated.documentNamespace());
...
let validAgreementApplication = (hrefType, schemaVersion) => schemaVersion >= slVersions.r7 && appTypes.includes(hrefType);
 ...
 */
export const isA177specification_URN = (urn) => SchemaVersions.find((v) => v?.URN == urn) != undefined;
