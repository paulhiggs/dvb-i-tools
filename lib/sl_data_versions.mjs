...
export let validAgreementApplication = (hrefType, schemaVersion) => 
	(schemaVersion >= SCHEMA_r7 && appTypes.includes(hrefType));
 ...
 */
export let validOutScheduleHours= (HowRelated, namespace) => 
 ...
 */
export let validContentFinishedBanner = (HowRelated, namespace) =>
 ...
 */
export let validServiceListLogo = (HowRelated, namespace) =>
 ...
 */
export let validServiceLogo = (HowRelated, namespace) =>
 ...
 */
export let validServiceBanner = (HowRelated, namespace) =>
 ...
 */
export let validContentGuideSourceLogo = (HowRelated, namespace) =>
