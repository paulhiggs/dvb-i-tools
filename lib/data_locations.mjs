...
export const DVBI_ServiceListSchema = {
	...
	r8: { file: join(__dirname, "dvbi_v8.0-with-hls-hbbtv.xsd") },
};

export const DVBI_ServiceListRegistrySchema = {
	r0: { file: join(__dirname, "dvbi_service_list_discovery_v1.0.xsd") },
	r1: { file: join(__dirname, "dvbi_service_list_discovery_v1.1.xsd") },
	r2: { file: join(__dirname, "dvbi_service_list_discovery_v1.2.xsd") },
	r3: { file: join(__dirname, "dvbi_service_list_discovery_v1.3.xsd") },
	r4: { file: join(__dirname, "dvbi_service_list_discovery_v1.4.xsd") },
	r5: { file: join(__dirname, "dvbi_service_list_discovery_v1.5.xsd") },
	r6: { file: join(__dirname, "dvbi_service_list_discovery_v1.6.xsd") },
	r7: { file: join(__dirname, "dvbi_service_list_discovery_v1.7.xsd") },
	r8: { file: join(__dirname, "dvbi_service_list_discovery_v1.7.xsd") },
};
