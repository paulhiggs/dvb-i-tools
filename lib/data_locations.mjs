...
const path2007CS = join(pathDVBCS, "2007"),
	...
	url2024CS = "cs/2024",
	path2026CS = join(pathDVBCS, "2026"),
	url2026CS = "cs/2026";
...
export const DVB_AudioConformanceCS = {
...
export const DVB_VideoConformanceCS = {
	...
	y2026: { file: join(path2026CS, idDVB_VideoConformanceCS), 
		url: `https://raw.githubusercontent.com/paulhiggs/metadata-website/refs/heads/master/metadata/${url2026CS}/VideoConformancePointsCS.xml`	
	//	url: `${DVB_METADATA}${url2026CS}/${idDVB_VideoConformanceCS}`	// TODO: use this URL once published on dvb.org/metadata
	},
};
...
export const DVB_ParentalGuidanceCS = { file: join(path2007CS, idDVB_ParentalGuidanceCS), url: `${DVB_METADATA}${url2007CS}/${idDVB_ParentalGuidanceCS}` };
