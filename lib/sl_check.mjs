	...
	/*public*/ doValidateServiceList(SLtext, errs, options = {}) {
		...
		if (CGSourceList) {
			...
			CGSourceList.forEachNamedChildElement(dvbi.e_ContentGuideSource, (CGSource) => {
				this.#validateAContentGuideSource(CGSource, `${dvbi.e_ServiceList}.${dvbi.e_ContentGuideSourceList}.${dvbi.e_ContentGuideSource}[${++cgs}]`, documentInfo, errs, "SL070");
		...
		if (slGCS) this.#validateAContentGuideSource(slGCS, `${dvbi.e_ServiceList}.${dvbi.e_ContentGuideSource}`, documentInfo, errs, "SL080");
