...
import { checkValidLogos, validateAnyContentDigests } from "./related_material_checks.mjs";
...
export default class ServiceListCheck {
	...
	/*public*/ doValidateServiceList(SLtext, errs, options = {}) {
		...
		// check <ServiceList><xmldsig:Signature>
		ValidateAnyXMLSignatures(ServiceList, errs, "SL900");
