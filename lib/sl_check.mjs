...
export default class ServiceListCheck {
	...
	/*private*/ #validateServiceInstance(ServiceInstance, thisServiceId, declaredSubscriptionPackages, declaredAudioLanguages, errs) {
		...
		checkTopElementsAndCardinality(
			...
			[
				...
				SchemaVersion(documentNamespace) >= slVersions.r3 ? { name: dvbi.e_AltServiceName, minOccurs: 0, maxOccurs: Infinity } : {},
				...
				SchemaVersion(documentNamespace) >= slVersions.r6 ? { name: dvbi.e_IdentifierBasedDeliveryParameters, minOccurs: 0 } : {},
	...
	/*private*/ #doSchemaVerification(ServiceList, errs, errCode, report_schema_version = true) {
		...
		if (x && x.schema) {
			SchemaCheck(ServiceList, x.schema, x.filename, errs, `${errCode}:${SchemaVersion(ServiceList.root.namespaceUri)}`);
