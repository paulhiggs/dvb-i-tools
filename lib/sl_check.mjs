...
import { isIni, unEntity, DuplicatedValue, parameterCheck, HexOrDecValue, DefaultProperty, HasProperty } from "./utils.mjs";
		...
		if (ProminenceList) {
			...
			ProminenceList.forEachNamedChildElement(dvbi.e_Prominence, (PE) => {
				...
				if (PE_country && PE_region) {
					const found = documentInfo.knownRegionIDs.find((r) => r.region == PE_region);
					if (found !== undefined && HasProperty(found, "countries")) {
