...
export default class ServiceListCheck {
	...
	/*private*/ #validateServiceInstance(ServiceInstance, thisServiceId, declaredSubscriptionPackages, declaredAudioLanguages, errs) {
		...
		if (ContentAttributes) {
			...
			ContentAttributes.forEachNamedChildElement(dvbi.e_AudioLanguage, (conf) => {
		...
		if (DASHDeliveryParameters) {
			...
			if (URIBasedLocation) {
				...
				if (uriContentType && !validDASHcontentType(uriContentType.value, SL_SchemaVersion(documentNamespace)))
					errs.addError({
						code: "SI173",
