...
const _S_RollOff : Array<string> = ["0.35"];  

// ETSI EN 300 421 table 3
const _S_FEC : Array<string> = ["1/2", "2/3", "3/4", "5/6", "7/8"]; 
...
const _S2_FEC : Array<string> = _S_FEC;

const _S2_Modulation : Array<string>  = ["8PSK"].concat(_S_Modulation);

const _S2X_RollOff : Array<string> = ["0.15", "0.10", "0.05"].concat(_S2_RollOff);

// ETSI EN 302 307-2 V1.4.1 table 1
const _S2X_FEC : Array<string> = ["1/3", "1/4", "2/5", "3/5", "4/5", "5/9", "7/9", "8/9", "8/15", "9/10", "9/20", "11/15", "11/20", "13/18", "13/45", "23/36", "25/36", "26/45", "28/45", "32/45", "77/90"].concat(_S_FEC);

// other FEC values found in ETSI EN 302 307-2 V1.4.1 table 1 but not included in A177r6
// 2/9, 1/5, 4/15, 11/45, 29/45, 31/45

const _S2X_Modulation : Array<string> = ["8PSK-L", "16APSK", "16APSK-L", "32APSK", "32APSK-L", "64APSK", "64APSK-L"].concat(_S2_Modulation);
