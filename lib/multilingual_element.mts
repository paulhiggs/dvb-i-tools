 ...
 */
export function mlLanguage(node : XmlElement | null) : string {
 ...
 * @param {XmlElement | null} node  The XML node containing the element being checked
 * @param {ErrorList} errs          The class where errors and warnings relating to the service list processing are stored
 * @param {string} errCode          The error code to be reported
 */
export function checkXMLLangs(elementName : string, elementLocation : string, node : XmlElement | null, errs : ErrorList, errCode : string) {
	if (!node) {
