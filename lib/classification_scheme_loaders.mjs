...
export function LoadPictureFormatCS(useURLs, async = true) {
	console.log(chalk.yellow.underline("loading Picture Formats..."));
	const cs = new ClassificationScheme();
...
export function LoadServiceTypeCS(useURLs, async = true) {
	console.log(chalk.yellow.underline("loading Service Types..."));
	const cs = new ClassificationScheme();
 ...
 */
export function LoadLinkedApplicationCS(useURLs, async = true) {
	console.log(chalk.yellow.underline("loading Linked Application Types..."));
	const cs = new ClassificationScheme();
	cs.loadCS(useURLs ? { url: DVBI_LinkedApplicationCS.url } : { file: DVBI_LinkedApplicationCS.file }, async);
	return cs;
}
