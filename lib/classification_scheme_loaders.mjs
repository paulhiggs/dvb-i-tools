...
export function LoadCountries(opts) {
	opts.verbose && console.log(chalk.yellow.underline("loading countries..."));
...
export function LoadLanguages(opts) {
	opts.verbose && console.log(chalk.yellow.underline("loading languages..."));
...
export function LoadVideoCodecCS(opts) {
	opts.verbose && console.log(chalk.yellow.underline("loading Video Codecs..."));
...
export function LoadAudioCodecCS(opts) {
	opts.verbose && console.log(chalk.yellow.underline("loading Audio Codecs..."));
	const cs = new ClassificationScheme();
	cs.loadCS(
		opts.useURLs
			? {
...
export function LoadGenres(opts) {
	opts.verbose && console.log(chalk.yellow.underline("loading Genres ..."));
	const cs = new ClassificationScheme();
	cs.loadCS(
		opts.useURLs
			? {
...
export function LoadAccessibilityPurpose(opts) {
	opts.verbose && console.log(chalk.yellow.underline("loading Accessibility Purposes..."));
	const cs = new ClassificationScheme();
...
export function LoadAudioPurpose(opts) {
	opts.verbose && console.log(chalk.yellow.underline("loading Audio Purposes..."));
	const cs = new ClassificationScheme();
...
export function LoadSubtitleCarriages(opts) {
	opts.verbose && console.log(chalk.yellow.underline("loading Subtitle Carriages..."));
	const cs = new ClassificationScheme();
...
export function LoadSubtitleCodings(opts) {
	opts.verbose && console.log(chalk.yellow.underline("loading Subtitle Codings..."));
	const cs = new ClassificationScheme();
...
export function LoadSubtitlePurposes(opts) {
	opts.verbose && console.log(chalk.yellow.underline("loading Subtitle Purposes..."));
	const cs = new ClassificationScheme();
...
export function LoadAudioConformanceCS(opts) {
	opts.verbose && console.log(chalk.yellow.underline("loading Audio Conformance Points..."));
	const cs = new ClassificationScheme();
...
export function LoadVideoConformanceCS(opts) {
	opts.verbose && console.log(chalk.yellow.underline("loading Video Conformance Points..."));
	const cs = new ClassificationScheme();
	cs.loadCS(
		opts.useURLs
			? {
...
export function LoadAudioPresentationCS(opts) {
	opts.verbose && console.log(chalk.yellow.underline("loading AudioPresentation..."));
	const cs = new ClassificationScheme();
...
export function LoadRecordingInfoCS(opts) {
	opts.verbose && console.log(chalk.yellow.underline("loading Recording Info..."));
	const cs = new ClassificationScheme();
...
export function LoadPictureFormatCS(opts) {
	opts.verbose && console.log(chalk.yellow.underline("loading Picture Formats..."));
	const cs = new ClassificationScheme();
...
export function LoadColorimetryCS(opts) {
	opts.verbose && console.log(chalk.yellow.underline("loading Colorimetry..."));
	const cs = new ClassificationScheme();
...
export function LoadServiceTypeCS(opts) {
	opts.verbose && console.log(chalk.yellow.underline("loading Service Types..."));
	const cs = new ClassificationScheme();
...
export function LoadRatings(opts) {
	opts.verbose && console.log(chalk.yellow.underline("loading Ratings..."));
	const cs = new ClassificationScheme();
...
export function LoadCredits(opts) {
	opts.verbose && console.log(chalk.yellow.underline("loading CreditsItem roles..."));
...
export function LoadLinkedApplicationCS(opts) {
	opts.verbose && console.log(chalk.yellow.underline("loading Linked Application Types..."));
	const cs = new ClassificationScheme();
