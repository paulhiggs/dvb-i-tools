...
export function LoadAudioCodecCS(useURLs, async = true) {
	...
	cs.loadCS(
		useURLs
			? {
					urls: [MPEG7_AudioCodingFormatCS.url, DVB_AudioCodecCS.y2007.url, DVB_AudioCodecCS.y2020.url, DVB_AudioCodecCS.y2024.url],
			  }
			: {
					files: [MPEG7_AudioCodingFormatCS.file, DVB_AudioCodecCS.y2007.file, DVB_AudioCodecCS.y2020.file, DVB_AudioCodecCS.y2024.file],
			  },
		async,
		[MPEG1_layer_2]
	);
