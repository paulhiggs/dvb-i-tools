...
import { isIn, isIni, unEntity, parseISOduration, DuplicatedValue, parameterCheck } from "./utils.mjs";
...
export default class ContentGuideCheck {
	...
	/* private */ #ValidateGroupInformation(GroupInformation, requestType, categoryGroup, indexes, groupsFound, errs) {
		...
		const GroupType = GroupInformation.getAnyNsValueOr(tva.e_GroupType, null);
		if (GroupType) {
			if (!(GroupType && GroupType == tva.t_ProgramGroupTypeType))
				errs.addError({
					code: "GI011",
