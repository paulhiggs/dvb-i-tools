 ...
 */
export const NoChildElement = (missingElement, parentElement, schemaLocation, errCode) => ({
	code: errCode,
 ...
 * @param {String}     errCode   The error number to show in the log
 */
export const cg_InvalidHrefValue = (value, element, loc, errCode) => ({
	code: errCode,
...
export const sl_InvalidHrefValue = (value, element, src, loc, errCode) => ({
	code: errCode,
	fragment: element,
...
export const InvalidURL = (value, element, src, errCode) => ({
	code: errCode,
	fragment: element,
 ...
 * 
 * @param {XmnlElement} what  the element that is deprecated
 ...
 */
export const DeprecatedElement = (what, since, errCode) => ({
	type: WARNING,
	code: errCode,
	fragment: what,
 ...
 * @returns {any} an error object to be passed to the logging function
 */
export const DeprecatedAttribute = (what, since, errCode) => ({
	type: WARNING,
	code: errCode,
 ...
 * @param {String} loc      The location of the element
 */
export const InvalidCountryCode = (value, src, loc) => `invalid country code ${value.quote()} ${src ? `for ${src} parameters ` : ""}in ${loc}`;
