 ...
 */
export const SLR_GetSchema = (namespace) => SchemaVersions.find((s) => s.namespace == namespace);


let SLRschemasLoaded = false;
export function LoadSLRschemas(useURLs, async = true, verbose = true) {
	...
	verbose && console.log(chalk.yellow.underline("loading service list registry schemas..."));
