...
declare global {
	interface Array<T> {
		forEachSubElement(callback : XmlElementArrayIteratorFunction, thisArg? : any) : void;
	}
}
...
if (!Array.prototype.forEachSubElement) {
	 ...
	 */
	Array.prototype.forEachSubElement = function (callback : XmlElementArrayIteratorFunction, thisArg : any = null) {
		if (this == null) {
...
declare global {
	interface Array<T> {
		forEachNamedSubElement(elementName : Array<string> | string, callback : XmlElementArrayIteratorFunction, thisArg? : any) : void;
	}
}
