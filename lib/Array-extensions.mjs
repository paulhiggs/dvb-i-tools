...
/**
 * Iterate through the array invoking the callback is the array item is a XmlElement with the specified name
 * 
 * @param {String} elementName  the name of the element that we want the callback to be invoked for
