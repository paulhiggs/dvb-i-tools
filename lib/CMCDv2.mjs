	...
	CMCDelem.forEachNamedChildElement(dvbi.e_Report, (Report) => {
		...
		switch (reporting_mode) {
			case CMCD_MODE_REQUEST:
				checkAttributes(
					Report,
					[dvbi.a_reportingMode, dvbi.a_transmissionMode],
					[dvbi.a_enabledKeys, dvbi.a_objectTypes, dvbi.a_probability, dvbi.a_obfuscateURL],
					dvbiEA.CMCDv2,
					errs,
					`${errCode}-1a`
				);
			...
			case CMCD_MODE_EVENT:
				checkAttributes(
					Report,
					[dvbi.a_reportingMode, dvbi.a_transmissionMode, dvbi.a_eventURL],
					[dvbi.a_batchSize, dvbi.a_eventTypes, dvbi.a_objectTypes, dvbi.a_enabledKeys, dvbi.a_probability, dvbi.a_obfuscateURL],
					dvbiEA.CMCDv2,
					errs,
					`${errCode}-2a`
				);
		...
		if (supported_CMCD_versions.includes(CMCDversion) && Object.prototype.hasOwnProperty.call(counts, reportingMode(reporting_mode))) {
