		...
		switch (reporting_mode) {
			case CMCD_MODE_REQUEST:
				checkAttributes(
					...
					[dvbi.a_enabledKeys, dvbi.a_probability, dvbi.a_obfuscateURL],
					dvbiEA.CMCDv2,
					errs,
					`${errCode}-1a`
				);
			...
			case CMCD_MODE_EVENT:
				checkAttributes(
					...
					[dvbi.a_batchSize, dvbi.a_enabledKeys, dvbi.a_probability, dvbi.a_obfuscateURL],
					dvbiEA.CMCDv2,
					errs,
					`${errCode}-2a`
				);
