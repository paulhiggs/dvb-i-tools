...
export default class ISOcountries {
	private countriesList : CountryInfo_type[];
	 ...
	 * @param {boolean} async           load the file asynchronously (default true)
	 */
	...
	loadCountries(options: SchemeLoadOptions, async: boolean = true) {
		if (!Object.prototype.hasOwnProperty.call(options, "purge")) options.purge = true;
