...
type FileLocationType = { file: string; url: string };
...
export const Default_SLEPR : FileLocationType = { file: join(SLEPR_Dir, SLEPR_File), url: `${REPO_RAW}${SLEPR_subDir}/${SLEPR_File}` };

const idTVA_ContentCS = "ContentCS.xml";
export const TVA_ContentCS : FileLocationType = { file: join(pathTVA, idTVA_ContentCS), url: `${REPO_RAW}${subdirTVA}/${idTVA_ContentCS}` };

const idTVA_FormatCS = "FormatCS.xml";
export const TVA_FormatCS : FileLocationType = { file: join(pathTVA, idTVA_FormatCS), url: `${REPO_RAW}${subdirTVA}/${idTVA_FormatCS}` };

const idTVA_PictureCS = "PictureFormatCS.xml";
export const TVA_PictureFormatCS : FileLocationType = { file: join(pathTVA, idTVA_PictureCS), url: `${REPO_RAW}${subdirTVA}/${idTVA_PictureCS}` };

const idTVA_ContentAlertCS = "ContentAlertCS.xml";
export const TVA_ContentAlertCS : FileLocationType = { file: join(pathTVA, idTVA_ContentAlertCS), url: `${REPO_RAW}${subdirTVA}/${idTVA_ContentAlertCS}` };

const idTVA_AccessibilityPurposeCS = "AccessibilityPurposeCS.xml";
export const TVA_AccessibilityPurposeCS : FileLocationType = { file: join(pathTVA, idTVA_AccessibilityPurposeCS), url: `${REPO_RAW}${subdirTVA}/${idTVA_AccessibilityPurposeCS}` };

const idTVA_AudioPurposeCS = "AudioPurposeCS.xml";
export const TVA_AudioPurposeCS : FileLocationType = { file: join(pathTVA, idTVA_AudioPurposeCS), url: `${REPO_RAW}${subdirTVA}/${idTVA_AudioPurposeCS}` };

const idTVA_SubtitleCarriageCS = "SubtitleCarriageCS.xml";
export const TVA_SubitleCarriageCS : FileLocationType = { file: join(pathTVA, idTVA_SubtitleCarriageCS), url: `${REPO_RAW}${subdirTVA}/${idTVA_SubtitleCarriageCS}` };

const idTVA_SubtitleCodingFormatCS = "SubtitleCodingFormatCS.xml";
export const TVA_SubitleCodingFormatCS : FileLocationType = { file: join(pathTVA, idTVA_SubtitleCodingFormatCS), url: `${REPO_RAW}${subdirTVA}/${idTVA_SubtitleCodingFormatCS}` };
...
export const DVBI_ContentSubject : FileLocationType = { file: join(pathDVBI, idDVB_ContentSubjectCS), url: `${DVB_METADATA}${url2019CS}/${idDVB_ContentSubjectCS}` };

const idDVB_ServiceTypeCS = "DVBServiceTypeCS-2019.xml";
export const DVBI_ServiceTypeCS : FileLocationType = { file: join(pathDVBI, idDVB_ServiceTypeCS), url: `${DVB_METADATA}${url2022CS}/${idDVB_ServiceTypeCS}` };
...
export const MPEG7_VisualCodingFormatCS : FileLocationType = { file: join(pathMPEG7, idMPEG7_VisualCodingFormatCS), url: `${REPO_RAW}${subdirMPEG7}/${idMPEG7_VisualCodingFormatCS}` };

const idMPEG7_AudioPresentationCS = "AudioPresentationCS.xml";
export const MPEG7_AudioPresentationCS : FileLocationType = { file: join(pathMPEG7, idMPEG7_AudioPresentationCS), url: `${REPO_RAW}${subdirMPEG7}/${idMPEG7_AudioPresentationCS}` };

const idDVB_AudioConformanceCS = "AudioConformancePointsCS.xml";
export const DVB_AudioConformanceCS : FileLocationType = { file: join(path2017CS, idDVB_AudioConformanceCS), url: `${DVB_METADATA}${url2017CS}/${idDVB_AudioConformanceCS}` };
...
export const DVB_VideoConformanceCS = {
	...
	y2024: {
		...
		url: `${DVB_METADATA}${url2024CS}/${idDVB_VideoConformanceCS}`,
	},
};

const idISO3166 = "iso3166-countries.json";
export const ISO3166 : FileLocationType = { file: join(pathISO, idISO3166), url: `${REPO_RAW}${subdirISO}/${idISO3166}` };

const idDVBI_RecordingInfoCS = "DVBRecordingInfoCS-2019.xml";
export const DVBI_RecordingInfoCS : FileLocationType = { file: join(pathDVBI, idDVBI_RecordingInfoCS), url: `${REPO_RAW}${subdirDVBI}/${idDVBI_RecordingInfoCS}` };

const v1Credits = "CreditsItem@role-values.txt";
export const DVBI_CreditsItemRoles : FileLocationType = { file: join(pathDVBI, v1Credits), url: `${REPO_RAW}${subdirDVBI}/${v1Credits}` };

const v2Credits = "CreditsItem@role-values-v2.txt";
export const DVBIv2_CreditsItemRoles : FileLocationType = { file: join(pathDVBI, v2Credits), url: `${REPO_RAW}${subdirDVBI}/${v2Credits}` };

const idDVB_ParentalGuidanceCS = "ParentalGuidanceCS.xml";
export const DVBI_ParentalGuidanceCS : FileLocationType = { file: join(path2007CS, idDVB_ParentalGuidanceCS), url: `${DVB_METADATA}${url2007CS}/${idDVB_ParentalGuidanceCS}` };
...
export const TVAschema = {
	...
	v2026: { namespace: `${TVAnamespace}:2026`, file: `./${schemasPath}/${TVAfileprefix}_2026.xsd` },
};
...
export const DVBI_ServiceListSchema = {
	...
	r4: { file:  `./${schemasPath}/dvbi_v4.0-with-hls-hbbtv.xsd` },
	r5: { file:  `./${schemasPath}/dvbi_v5.0-with-hls-hbbtv.xsd` },
	r6: { file:  `./${schemasPath}/dvbi_v6.0-with-hls-hbbtv.xsd` },
	r7: { file:  `./${schemasPath}/dvbi_v7.0-with-hls-hbbtv.xsd` },
	r8: { file:  `./${schemasPath}/dvbi_v8.0-with-hls-hbbtv.xsd` },
};

export const DVBI_ServiceListRegistrySchema = {
	...
	r4: { file:  `./${schemasPath}/dvbi_service_list_discovery_v1.4.xsd` },
	r5: { file:  `./${schemasPath}/dvbi_service_list_discovery_v1.5.xsd` },
	r6: { file:  `./${schemasPath}/dvbi_service_list_discovery_v1.6.xsd` },
	r7: { file:  `./${schemasPath}/dvbi_service_list_discovery_v1.7.xsd` },
	r8: { file:  `./${schemasPath}/dvbi_service_list_discovery_v1.8.xsd` },
};
