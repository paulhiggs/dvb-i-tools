...
import { ValidateAnyXMLSignatures } from "./XML_Signatures.mjs";
...
export default class ServiceListRegistryCheck {
	...
	/*public*/ doValidateServiceListRegistry(SLRtext, errs, options = {}) {
		...
		//<ServiceListEntryPoints><xmldsig:Singature>
		ValidateAnyXMLSignatures(ServiceListRegistry, errs, "SR900");
	}
