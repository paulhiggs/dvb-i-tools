...
export const tvaEA = {	// EA = Element-Attributes - the attributes that are defiend for each element
...
export const tvaEC = { // EC = Element-Children - the child elements or each element
	...
	BasicDescription: [tva.e_Title, tva.e_MediaTitle, tva.e_ShortTitle, tva.e_Synopsis, tva.e_PromotionalInformation, tva.e_Keyword, tva.e_Genre, tva.e_ParentalGuidance,
						tva.e_Language, tva.e_SignLanguage, tva.e_CaptionLanguage, tva.e_CreditsList, tva.e_AwardsList, tva.e_RelatedMaterial, tva.e_ProductionDate,
						tva.e_ProductionLocation, tva.e_CreationCoordinates, tva.e_DepictedCoordinates, tva.e_ReleaseInformation, tva.e_PublishedDuration, tva.e_PurchaseList],
	...
	InstanceDescription: [tva.e_Title, tva.e_Synopsis, tva.e_Genre, tva.e_PurchaseList, tva.e_CaptionLanguage, tva.e_SignLanguage, tva.e_ParentalGuidance, tva.e_AVAttributes,
							tva.e_MemberOf, tva.e_OtherIdentifier, tva.e_RelatedMaterial],
	MediaLocator: [tva.e_MediaUri, tva.e_AuxiliaryURI, tva.e_InlineMedia, tva.e_StreamID],
	OnDemandProgram: [tva.e_PublishedDuration, tva.e_StartOfAvailability, tva.e_EndOfAvailability, tva.e_FirstAvailability, tva.e_LastAvailability, tva.e_ImmediateViewing,
						tva.e_DeliveryMode, tva.e_ContentVersion, tva.e_ExpiryDate, tva.e_EarlyPlayout, tva.e_Free, tva.e_ExpiryTimeAfterFirstStart, tva.e_EmbargoTime,
						tva.e_MaxNumberOfDownloads, tva.e_ExpiryTimeAfterDownload, tva.e_ExpiryTimeAfterDownloadFirstStart].concat(ProgramLocationType),
	ProgramDescription: [tva.e_ProgramInformationTable, tva.e_GroupInformationTable, tva.e_ProgramInformationTable, tva.e_ServiceInformationTable, 
	...
	ScheduleEvent: [tva.e_PublishedStartTime, tva.e_PublishedEndTime, tva.e_PublishedDuration, tva.e_ActualStartTime, tva.e_ActualEndTime, tva.e_ActualDuration,
					tva.e_DeliveryMode, tva.e_Repeat, tva.e_FirstShowing, tva.e_LastShowing, tva.e_Free].concat(ProgramLocationType),
