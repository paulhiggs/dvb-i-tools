...
module.exports.DVB_VideoCodecCSFilename=path.join("dvb/cs/", DVB_VideoCodecCS2007);
module.exports.DVB_VideoCodecCSURL=`${DVB_METADATA}cs/${DVB_VideoCodecCS2007}`;

const DVB_VideoCodecCS2020="2020/VideoCodecCS.xml";
module.exports.DVB_VideoCodecCS2020Filename=path.join("dvb/cs", DVB_VideoCodecCS2020);
module.exports.DVB_VideoCodecCS2020URL=`${DVB_METADATA}cs/${DVB_VideoCodecCS2020}`;
...
module.exports.DVB_VideoConformanceCSFilename=path.join("dvb/cs/2017", DVB_VideoConformanceCS);
module.exports.DVB_VideoConformanceCSURL=`${DVB_METADATA}cs/2017/${DVB_VideoConformanceCS}`;
